                     ...
                     <!-- Primeiro grupo Collapse -->
                        <div class="accordion-item">
                            ...
                            <div class="accordion-body">
                                ...
                                <!-- Segundo grupo Collapse -->
                                <div class="accordion" id="accordionExampleTwo">
                                <div class="accordion-item">
                                <?php foreach(range(0,5) as $k) : ?>   
                                    <h2 class="accordion-header" id="headingTwo">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo<?=$k?>" aria-expanded="false" aria-controls="collapseTwo<?=$k?>">
                                            <span class="me-2">Cidade <?=$k?></span>
                                        </button>
                                    </h2>
                                    
                                    <div id="collapseTwo<?=$k?>" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExampleTwo">
                                    <div class="accordion-body">
                        
                                        <!-- Terceiro grupo Collapse -->
                                        <div class="accordion" id="accordionExampleThree">
                                        <div class="accordion-item">
                                        <?php foreach(range(0,3) as $m) : ?>  
                                            <h2 class="accordion-header" id="headingThree">
                                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree<?=$m?>" aria-expanded="false" aria-controls="collapseThree<?=$m?>">
                                                <span class="me-2">Unidade <?=$m?></span>
                                            </button>
                                            </h2>
                                            <div id="collapseThree<?=$m?>" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExampleThree">
                                            <div class="accordion-body">
                                                <div class="row d-flex justify-content-center infoss m-2">    
