        ...
        <div class="row">
            ...
            <div class="col-lg-12 w-100 col-12 bg-dange d-flex align-items-center justify-content-center">
                ...
                <div class="accordion-item">
                        ...
                        <div id="collapseOne<?=$i?>" class="accordion-collapse collapse overflow-hidden" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                            <div class="accordion-body bg-light row">
                            <div class="col-lg-2 col-xl-3 col-xxl-3 col-md-6 col-12 p-0 imagem">
                                <img class="w-100 h-100 object-fit-cover" src="<?= asset('images/banners/caminhao.png') ?>" alt="">
                            </div>
                            <div class="col-lg-4 col-xl-3 col-xxl-3 col-md-6 col-12 p-0 bg-cinza infos px-lg-1 px-2 py-1 d-flex justify-content-center align-items-center flex-column">
                                <div class="m-auto">
                                    <h2 class="h2 h2-20 text-lg-start ps-lg-0-50 ps-0 mb-1 mt-1 w-100">Matriz - Caxias do Sul</h2>
                                    <p class="p p-16 text-lg-start w-100">
                                        <svg class="ms-0-50 me-0-50" width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="col-lg-6 col-xl-6 col-xxl-6 flex-column p-lg-3 p-2">
